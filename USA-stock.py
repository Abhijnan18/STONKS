...
def get_past_5day_prices_us(company_symbol):
  """
  Retrieves past 5 days of closing prices for a company's shares
  registered in the US stock market.

  Args:
    company_symbol: The symbol of the company on the US stock exchange.
...
past_5day_prices = get_past_5day_prices_us(company_symbol)

print(f"Past 5 days closing prices for {company_symbol}:")
